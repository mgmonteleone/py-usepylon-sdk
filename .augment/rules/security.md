...
- Use `python-dotenv` or `pydantic-settings` for loading environment variables in development
- For production, use secret managers (e.g., Google Secret Manager, AWS Secrets Manager, HashiCorp Vault)
